...
from subnet.utils.data_structures import RemoteInfo, RemoteModuleInfo, ServerState
from subnet.utils.dht import sort_peers
...
class RemoteServerInfo:
    ...
    def __getitem__(self, ix: slice):
        ...
        return RemoteServerInfo(server_infos, servers_by_priority, self.last_updated_time)

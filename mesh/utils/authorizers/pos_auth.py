...
from mesh.utils.crypto import Ed25519PrivateKey, Ed25519PublicKey, RSAPrivateKey, RSAPublicKey, load_public_key_from_bytes
...
class ProofOfStakeAuthorizer(AuthorizerBase):
    ...
    async def sign_request(
        self, request: AuthorizedRequestBase, service_public_key: Optional[RSAPublicKey | Ed25519PublicKey]
    ) -> None:
        auth = request.auth

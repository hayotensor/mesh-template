    ...
    def get_overwatch_commits(self, epoch: int, overwatch_node_id: int):
        ...
        def make_rpc_request():
            try:
                with self.interface as _interface:
                    data = _interface.rpc_request(
                        method="network_getOverwatchCommitsForEpochAndNode", params=[epoch, overwatch_node_id]
                    )
                    return data
            except SubstrateRequestException as e:
                logger.error("Failed to get rpc request: {}".format(e))
    ...
    def get_overwatch_reveals(self, epoch: int, overwatch_node_id: int):
        ...
        def make_rpc_request():
            try:
                with self.interface as _interface:
                    data = _interface.rpc_request(
                        method="network_getOverwatchRevealsForEpochAndNode", params=[epoch, overwatch_node_id]
                    )
                    return data
            except SubstrateRequestException as e:
                logger.error("Failed to get rpc request: {}".format(e))
            ...
            try:
                with self.interface as _interface:
                    result = _interface.rpc_request(
                        method="network_proofOfStake", params=[subnet_id, peer_id, min_class]
                    )
                    return result
            except SubstrateRequestException as e:
                logger.error("Failed to get rpc request: {}".format(e))
    ...
    def get_elected_validator_info(self, subnet_id: int, subnet_epoch: int):
        ...
        def make_rpc_request():
            try:
                with self.interface as _interface:
                    data = _interface.rpc_request(
                        method="network_getElectedValidatorInfo", params=[subnet_id, subnet_epoch]
                    )
                    return data
            except SubstrateRequestException as e:
                logger.error("Failed to get rpc request: {}".format(e))
